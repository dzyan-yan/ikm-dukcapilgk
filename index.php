...
<head>
  ...
  <title>Survey | Disdukcapil</title>
...
function showSweetAlert() {
  ...
  icon: "success",
  title: "Terimakasih",
  text: "Anda Telah Memberikan Penilaian",
  ...
  <!-- head -->
  <div class="head text-center mt-2 mb-3">
  ...
  <!-- Awal Container -->
  <div class="container">
    <div class="text-center mt-3 mb-3"> <h1>BAGAIMANA PELAYANAN KAMI ??? </h1></div>
    <div class="row mt-1">
      <!-- Card Option Sangat Puas -->
      <div class="col-xl-3 col-md-6 mb-4">
        <button class="btn btn-light" onclick="showSweetAlert()">
              ...
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <a href="?ket=sangat_puas" title="Klik icon ini jika anda PUAS dengan pelayanan kami">
                    <h4>Sangat Puas</h4>
                    <img src="assets/img/sangat_puas.png" class="img-fluid">
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <a href="?ket=puas" title="Klik icon ini jika anda PUAS dengan pelayanan kami">
                  <h4>Puas</h4>
                  <img src="assets/img/puass.png" class="img-fluid">
                </a>
              </div>
            </div>
          </div>
            ...
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <a href="?ket=cukup" title="Klik icon ini jika anda KURANG PUAS dengan pelayanan kami">
                  <h4>Cukup</h4>
                  <img src="assets/img/cukupp.png" class="img-fluid">
                </a>
              </div>
            </div>
          </div>
            ...
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <a href="?ket=tidak_puas" title="Klik icon ini jika anda TIDAK PUAS dengan pelayanan kami">
                  <h4>Tidak Puas</h4>
                  <img src="assets/img/tidak_puas.png" class="img-fluid">
                </a>
              </div>
            </div>
          </div>
